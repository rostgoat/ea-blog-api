...
let Comment = class Comment {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { comment_id: { required: true, type: () => String }, uid: { required: true, type: () => String }, content: { required: true, type: () => String }, post: { required: true, type: () => require("../post/post.entity").Post } };
    }
};
__decorate([
...
], Comment.prototype, "createUID", null);
Comment = __decorate([
