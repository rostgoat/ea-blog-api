...
let Post = class Post {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { post_id: { required: true, type: () => String }, uid: { required: true, type: () => String }, title: { required: true, type: () => String }, sub_title: { required: true, type: () => String }, content: { required: true, type: () => String }, created_at: { required: true, type: () => Date }, user: { required: true, type: () => require("../user/user.entity").User }, comments: { required: true, type: () => [require("../comment/comment.entity").Comment] }, photo: { required: true, type: () => require("../photo/photo.entity").Photo }, likes: { required: true, type: () => [require("../like/like.entity").Like] } };
    }
};
__decorate([
...
__decorate([
    typeorm_1.Column('text'),
    __metadata("design:type", String)
], Post.prototype, "sub_title", void 0);
__decorate([
    typeorm_1.Column('text'),
    __metadata("design:type", String)
...
__decorate([
    typeorm_1.OneToOne(type => photo_entity_1.Photo, {
        cascade: true,
    }),
...
], Post.prototype, "generateUID", null);
Post = __decorate([
